...
\usepackage{longtable} % 解决 Environment longtable undefined 问题
...
\XeTeXlinebreakskip = 0pt plus 1pt minus 0.1pt    %這兩行一定要加，中文才能自動換行



% Chinese characters size settings
...
\hypersetup{breaklinks=true,
            ...
            pdfproducer={XeLateX with as hyperref},
            pdfcreator={LaTeX with hyperref package @askenderlee},
            pdfinfo={%
              CopyrightStatus={Copyrighted},
              CopyrightNotice={Copyleft ^,^ 2013 by askender}
            }
